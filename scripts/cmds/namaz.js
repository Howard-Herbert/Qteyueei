...
module.exports = {
    config: {
        ...
        description: {
            ...
            en: "Retrieve times for a location."
        },
        category: "Tools",
        guide: {
            vi: "{pn} <địa điểm>",
    ...
    onStart: async function ({ api, args, event }) {
        try {
            ...
            const Siddik = `https://rubish-apihub.onrender.com/rubish/namaj?location=${encodeURIComponent(location)}&apikey=rubish69`;

            const response = await axios.get(Siddik);
