...
module.exports = {
    ...
    onStart: async function ({ message, event, args }) {
        try {
            ...
            const avatarResponse = await axios.get(`https://graph.facebook.com/${id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: 'arraybuffer' });
            ...
            message.reply("Error occurred while generating the image.");
        }
    }
};
